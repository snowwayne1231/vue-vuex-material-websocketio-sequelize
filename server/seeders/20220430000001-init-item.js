...
const dataset = [
  ...
  {name: '聲東擊西', detail: '指定任一敵方野區，將其所有鄰近一格的據點中，所有該國武將移到指定野區，並扣除其行動力1點 (已經加入戰役的武將不受地圖移動影響)', lv: 0, when: 1, object: 9, timeTerm: 0, staticKey: '_STRATEGY_EAST_WEST_'},
  ...
  {name: '石兵八陣', detail: '指定鄰近一格敵方城池，將指定城池所有鄰近一格內的該國據點裡所有武將，移到指定城池並扣除全部行動力 (已經加入戰役的武將不受地圖移動影響)', lv: 1, when: 1, object: 6, timeTerm: 0, staticKey: '_STRATEGY_TRAPE_'},
  {name: '空城計', detail: '使用時，若所在地正處在戰役，且該戰役未出戰防守武將，則直接取消該出征戰役並將出征此城池的武將全數撤回主城 (資源不返還，貢獻值會保留) (戰役時間已超過將會失效)', lv: 0, when: 1, object: 0, timeTerm: 0, staticKey: '_STRATEGY_EMPTY_CITY_'},
  ...
  {name: '反間計', detail: '使用時，奪走自身所在地鄰近一格敵方的據點裡，一位兵力最多之"無加入戰役的敵方武將"一半兵力', lv: 0, when: 0, object: 0, timeTerm: 0, staticKey: '_STRATEGY_SOLDIER_STEAL_'},
  {name: '連環計', detail: '使用時，所在地鄰近一格內所有"修整中"據點裡之所有"無加入戰役"武將，其兵力數全部平均 (小數點無條件捨去)', lv: 0, when: 0, object: 0, timeTerm: 0, staticKey: '_STRATEGY_AVERAGE_'},
];
